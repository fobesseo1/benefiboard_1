...
const RepostSectionSkeleton = () => {
  return (
    <div className="w-full px-4 lg:w-[466px] lg:border border-gray-200 rounded-2xl">
      <div className="h-8 w-3/4 bg-gray-200 rounded my-4 "></div>
      ...
      <div className="relative h-12 mt-4">
        <div className="absolute w-24 h-12 bottom-0 left-1/2 transform -translate-x-1/2 bg-gray-200 rounded-full "></div>
      </div>
    </div>
  );
};
